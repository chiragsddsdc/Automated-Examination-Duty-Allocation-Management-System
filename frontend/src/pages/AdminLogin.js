    ...
    <div style={{
      ...
      <div style={{ position: 'relative', zIndex: 2, width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{
          ...
          boxShadow: '0 0 80px rgba(168,85,247,0.1), 0 32px 80px rgba(0,0,0,0.5)',
        }}>
            ...
            <>
              ...
              <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                ...
                <p style={{ fontSize: '13px', color: 'rgba(226,232,240,0.45)', lineHeight: '1.5' }}>
                  Sign in to manage faculty and allocations
                </p>
              </div>
              ...
              <form onSubmit={handleLogin} noValidate>
                ...
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: '0.2px',
                    fontFamily: 'inherit',
                    boxShadow: loading ? 'none' : '0 4px 24px rgba(168,85,247,0.4)',
                    transition: 'all 0.2s',
                  }}
              ...
              <div style={{ textAlign: 'center', fontSize: '13px', color: 'rgba(226,232,240,0.4)' }}>
                ...
                <Link to="/faculty-login" style={{
                  color: '#60a5fa', fontWeight: '600', textDecoration: 'none',
                }} className="al-portal-link">
                  Faculty Portal →
                </Link>
              </div>
            </>
          ...
          {mode === 'denied' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{
                ...
                Your account is registered as <strong style={{ color: '#f87171' }}>Faculty</strong>, not Administrator.
                Please use the Faculty Portal to sign in.
              </p>
          ...
          {mode === 'forgot-sent' && (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: '13px', color: 'rgba(226,232,240,0.5)', lineHeight: '1.65', marginBottom: '20px' }}>
                If <strong style={{ color: '#c084fc' }}>{forgotEmail}</strong> is registered, a reset link has been sent.
              </p>
              <div style={{
      ...
      <style>{`
        ...
        .al-blob-1 {
          ...
          animation: al-float1 14s ease-in-out infinite alternate;
        }
        .al-blob-2 {
          width: 400px; height: 400px;
          background: radial-gradient(circle, #4f46e5, transparent 70%);
          bottom: -150px; right: -100px;
          animation: al-float2 11s ease-in-out infinite alternate;
        }
        @keyframes al-float1 {
        ...
        .al-input::placeholder { color: rgba(226,232,240,0.2); }
        ...
        /* Link buttons */
        .al-link-btn:hover { opacity: 0.8 !important; }
        .al-portal-link:hover { opacity: 0.8 !important; }
        .al-back-link:hover { color: rgba(226,232,240,0.7) !important; }
        .al-eye-btn:hover { opacity: 1 !important; }

        @media (max-width: 480px) {
          .al-back-link { margin-bottom: 20px !important; }
        }
      `}</style>
    </div>
  );
